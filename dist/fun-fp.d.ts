 ...
 * Built: 2026-08-28T15:28:21.105Z
...
export interface FunctorInstances     { readonly maybe: MaybeTypeLambda }
export interface ApplyInstances       { readonly maybe: MaybeTypeLambda }
export interface ApplicativeInstances { readonly maybe: MaybeTypeLambda }
export interface ChainInstances       { readonly maybe: MaybeTypeLambda }
export interface ChainRecInstances    { readonly maybe: MaybeTypeLambda }
export interface MonadInstances       { readonly maybe: MaybeTypeLambda }
export interface AltInstances         { readonly maybe: MaybeTypeLambda }
export interface PlusInstances        { readonly maybe: MaybeTypeLambda }
export interface AlternativeInstances { readonly maybe: MaybeTypeLambda }
export interface FoldableInstances    { readonly maybe: MaybeTypeLambda }
export interface TraversableInstances { readonly maybe: MaybeTypeLambda }
export interface FilterableInstances  { readonly maybe: MaybeTypeLambda }
...
export interface SemigroupoidInstances { readonly maybe: MaybeKleisliTypeLambda }
export interface CategoryInstances     { readonly maybe: MaybeKleisliTypeLambda }
...
export interface FunctorInstances     { readonly either: EitherTypeLambda }
export interface ApplyInstances       { readonly either: EitherTypeLambda }
export interface ApplicativeInstances { readonly either: EitherTypeLambda }
export interface AltInstances         { readonly either: EitherTypeLambda }
export interface ChainInstances       { readonly either: EitherTypeLambda }
export interface ChainRecInstances    { readonly either: EitherTypeLambda }
export interface MonadInstances       { readonly either: EitherTypeLambda }
export interface MonadErrorInstances  { readonly either: EitherTypeLambda }
export interface FoldableInstances    { readonly either: EitherTypeLambda }
export interface TraversableInstances { readonly either: EitherTypeLambda }
export interface BifunctorInstances   { readonly either: EitherTypeLambda }
...
export interface SemigroupoidInstances { readonly either: EitherKleisliTypeLambda }
export interface CategoryInstances     { readonly either: EitherKleisliTypeLambda }
...
export interface FunctorInstances     { readonly task: TaskTypeLambda }
export interface ApplyInstances       { readonly task: TaskTypeLambda }
export interface ApplicativeInstances { readonly task: TaskTypeLambda }
export interface AltInstances         { readonly task: TaskTypeLambda }
export interface ChainInstances       { readonly task: TaskTypeLambda }
export interface ChainRecInstances    { readonly task: TaskTypeLambda }
export interface MonadInstances       { readonly task: TaskTypeLambda }
export interface MonadErrorInstances  { readonly task: TaskTypeLambda }
...
export interface SemigroupoidInstances { readonly task: TaskKleisliTypeLambda }
export interface CategoryInstances     { readonly task: TaskKleisliTypeLambda }
...
export interface FunctorInstances     { readonly validation: ValidationTypeLambda }
export interface ApplyInstances       { readonly validation: ValidationTypeLambda }
export interface ApplicativeInstances { readonly validation: ValidationTypeLambda }
export interface FoldableInstances    { readonly validation: ValidationTypeLambda }
export interface BifunctorInstances   { readonly validation: ValidationTypeLambda }
...
export interface FunctorInstances     { readonly nonemptylist: NonEmptyListTypeLambda }
export interface ApplyInstances       { readonly nonemptylist: NonEmptyListTypeLambda }
export interface ApplicativeInstances { readonly nonemptylist: NonEmptyListTypeLambda }
export interface ChainInstances       { readonly nonemptylist: NonEmptyListTypeLambda }
export interface ChainRecInstances    { readonly nonemptylist: NonEmptyListTypeLambda }
export interface MonadInstances       { readonly nonemptylist: NonEmptyListTypeLambda }
export interface AltInstances         { readonly nonemptylist: NonEmptyListTypeLambda }
export interface FoldableInstances    { readonly nonemptylist: NonEmptyListTypeLambda }
export interface ReducibleInstances   { readonly nonemptylist: NonEmptyListTypeLambda }
export interface TraversableInstances { readonly nonemptylist: NonEmptyListTypeLambda }
export interface ExtendInstances      { readonly nonemptylist: NonEmptyListTypeLambda }
export interface ComonadInstances     { readonly nonemptylist: NonEmptyListTypeLambda }
export interface SemigroupInstances   { readonly nonemptylist: NonEmptyList<unknown> }
...
export interface FunctorInstances     { readonly reader: ReaderTypeLambda }
export interface ApplyInstances       { readonly reader: ReaderTypeLambda }
export interface ApplicativeInstances { readonly reader: ReaderTypeLambda }
export interface ChainInstances       { readonly reader: ReaderTypeLambda }
export interface MonadInstances       { readonly reader: ReaderTypeLambda }
...
export interface FunctorInstances     { readonly writer: WriterTypeLambda }
export interface ApplyInstances       { readonly writer: WriterTypeLambda }
export interface ApplicativeInstances { readonly writer: WriterTypeLambda }
export interface ChainInstances       { readonly writer: WriterTypeLambda }
export interface MonadInstances       { readonly writer: WriterTypeLambda }
...
export interface FunctorInstances     { readonly state: StateTypeLambda }
export interface ApplyInstances       { readonly state: StateTypeLambda }
export interface ApplicativeInstances { readonly state: StateTypeLambda }
export interface ChainInstances       { readonly state: StateTypeLambda }
export interface MonadInstances       { readonly state: StateTypeLambda }
...
export interface FunctorInstances { readonly store: StoreTypeLambda }
export interface ExtendInstances  { readonly store: StoreTypeLambda }
export interface ComonadInstances { readonly store: StoreTypeLambda }
...
export interface FunctorInstances     { readonly free: FreeTypeLambda<TypeLambda> }
export interface ApplyInstances       { readonly free: FreeTypeLambda<TypeLambda> }
export interface ApplicativeInstances { readonly free: FreeTypeLambda<TypeLambda> }
export interface ChainInstances       { readonly free: FreeTypeLambda<TypeLambda> }
export interface MonadInstances       { readonly free: FreeTypeLambda<TypeLambda> }
...
export interface FunctorInstances      { readonly array: ArrayTypeLambda }
export interface ApplyInstances        { readonly array: ArrayTypeLambda }
export interface ApplicativeInstances  { readonly array: ArrayTypeLambda }
// Identity / Const 는 Array 절이 아니지만 같은 declare module 블록에 둔다 — 파일 하단 참조.
export interface ChainInstances        { readonly array: ArrayTypeLambda }
export interface ChainRecInstances     { readonly array: ArrayTypeLambda }
export interface MonadInstances        { readonly array: ArrayTypeLambda }
export interface AltInstances          { readonly array: ArrayTypeLambda }
export interface PlusInstances         { readonly array: ArrayTypeLambda }
export interface AlternativeInstances  { readonly array: ArrayTypeLambda }
export interface FoldableInstances     { readonly array: ArrayTypeLambda }
export interface TraversableInstances  { readonly array: ArrayTypeLambda }
export interface FilterableInstances   { readonly array: ArrayTypeLambda }
export interface ExtendInstances       { readonly array: ArrayTypeLambda }
export interface ComonadInstances      { readonly array: ArrayTypeLambda }
...
export interface FunctorInstances       { readonly function: FunctionTypeLambda }
export interface ApplyInstances         { readonly function: FunctionTypeLambda }
export interface ApplicativeInstances   { readonly function: FunctionTypeLambda }
export interface ChainInstances         { readonly function: FunctionTypeLambda }
export interface MonadInstances         { readonly function: FunctionTypeLambda }
export interface ContravariantInstances { readonly predicate: FunctionTypeLambda }
export interface ProfunctorInstances    { readonly function: FunctionTypeLambda }
export interface StrongInstances        { readonly function: FunctionTypeLambda }
export interface ChoiceInstances        { readonly function: FunctionTypeLambda }
export interface WanderInstances        { readonly function: FunctionTypeLambda }
export interface SemigroupoidInstances  { readonly function: FunctionTypeLambda }
export interface CategoryInstances      { readonly function: FunctionTypeLambda }
...
export interface FilterableInstances { readonly object: ObjectTypeLambda }
export interface FoldableInstances   { readonly object: ObjectTypeLambda }
export interface BifunctorInstances  { readonly tuple: TupleTypeLambda }
...
export interface FunctorInstances      { readonly identity: IdentityTypeLambda }
export interface ApplyInstances        { readonly identity: IdentityTypeLambda }
export interface FoldableInstances     { readonly identity: IdentityTypeLambda }
export interface ReducibleInstances    { readonly identity: IdentityTypeLambda }
export interface ApplicativeInstances  { readonly identity: IdentityTypeLambda }
// identity 는 Chain/Monad 까지 오른다(트랜스포머의 안쪽 모나드 자격) —
// Extend/Comonad 는 값 하나짜리 컨테이너의 자명한 코모나드.
export interface ChainInstances        { readonly identity: IdentityTypeLambda }
export interface MonadInstances        { readonly identity: IdentityTypeLambda }
export interface ExtendInstances       { readonly identity: IdentityTypeLambda }
export interface ComonadInstances      { readonly identity: IdentityTypeLambda }
...
export interface ChoiceInstances { readonly tagged: TaggedTypeLambda }
