...
type _st1 = Assert<typeof st1, Parameters<typeof SM.map<Counter, number, never>>[1]>;
...
type _st2 = Assert<typeof st2Run, Maybe<[number, Counter]>>;
...
type _st6 = Assert<typeof st6, ReturnType<typeof SM.of<number, Counter>>>;
...
type _rt1 = Assert<typeof rt1Run, Task<number>>;
...
type _wt1 = Assert<typeof wt1Run, Task<[number, string[]]>>;
