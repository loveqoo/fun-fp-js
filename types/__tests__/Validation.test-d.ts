...
type _1a = Expect<Equals<typeof v1, Valid<number>>>;
type _1b = Expect<Equals<typeof i1, Invalid<string[]>>>;
type _1c = Expect<Equals<typeof o1, Validation<never, number>>>;

// ── 2. map preserves E, transforms A ──────────────────────────────────
declare const v2: Validation<string[], number>;
const v2b = Validation.map((n: number) => n.toString(), v2);
type _2 = Expect<Equals<typeof v2b, Validation<string[], string>>>;

// ── 3. Type guards ────────────────────────────────────────────────────
declare const v3: Validation<string[], number>;
if (v3.isValid()) {
    type _3a = Expect<Equals<typeof v3, Valid<number>>>;
    const val: number = v3.value;
}
if (v3.isInvalid()) {
    type _3b = Expect<Equals<typeof v3, Invalid<string[]>>>;
...
type _4 = Expect<Equals<typeof v4, Validation<string[], string>>>;
...
type _5 = Expect<Equals<typeof v5b, Validation<string[], string>>>;

// ── 6. toEither conversion ────────────────────────────────────────────
declare const v6: Validation<string[], number>;
const e6 = v6.toEither();
type _6 = Expect<Equals<typeof e6, Either<string[], number>>>;

// ── 7. fromEither ─────────────────────────────────────────────────────
declare const e7: Either<string, number>;
const v7 = Validation.fromEither(e7);
type _7 = Expect<Equals<typeof v7, Validation<string, number>>>;
