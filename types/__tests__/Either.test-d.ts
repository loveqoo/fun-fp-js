...
type _1a = Assert<typeof l1, Left<string>>;
type _1b = Assert<typeof r1, Right<number>>;
type _1c = Assert<typeof e1, Either<never, number>>;
type _1d = Assert<Left<string>, Either<string, never>>;
type _1e = Assert<Right<number>, Either<never, number>>;
...
type _5 = Assert<typeof e5b, Either<string, number>>;

// ── 6. Applicative.of('either').of ────────────────────────────────────
const aEither = Applicative.of("either");
const e6 = aEither.of(42);
type _6 = Assert<typeof e6, Either<never, number>>;
...
type _7 = Assert<typeof e7, Either<null, string>>;
...
type _13 = Assert<typeof e13b, Either<string, string>>;
...
type _14 = Assert<typeof e14, Either<never, number>>;
...
type _14b = Assert<typeof e14b, Either<string, number>>;
...
type _15 = Assert<KEither, Either<string, number>>;
